...
import { portfolioData } from '@/data/portfolioData'; // Import the data from the new file
...
const ProjectPage = ({ project }: ProjectPageProps) => {
    ...
    return (
        <>
            <Head>
                <title>{`${project?.title || 'Untitled Project'} | ${portfolioData.personalInfo.name}`}</title>
            </Head>
            {/*========= Header ==========*/}
            <header className={styles.ProjectSinglePage}>
                <div ref={imageRef} className={styles.imageWrapper}>
                    <Image
                        ...
                        height={500}
                        unoptimized
                        className={(project.slug === 'shesup-ecommerce' || project.slug === 'bk-food-international') ? styles.shadowed : undefined}
                    />
                </div>
