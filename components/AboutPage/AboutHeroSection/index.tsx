        ...
        <section className={styles.aboutHero}>
            ...
            <div className={styles.wrapper}>
                <div className={styles.text}>
                    <h2 ref={headingRef}>
                        {splitText("Over 5 years of experience, specializing in immersive design, interactive experiences, and creative web development.")}
                    </h2>
                    <h2 ref={heading2Ref}>
                        {splitText("Passionate about pushing the boundaries of web design with Framer, GSAP animations, and modern CMS solutions.")}
                    </h2>
                </div>

                <div className={styles.image} ref={imageRef}>
                    <Image src='/images/about.png' alt={portfolioData.personalInfo.name} width={500} height={500} unoptimized />
                </div>
            </div>
        </section>
    );
