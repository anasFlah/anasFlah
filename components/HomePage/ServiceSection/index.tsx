...
const services: Service[] = [
    {
        ...
        numbering: "01",
        listItems: ["GSAP Animations", "Interactive Experiences", "Framer Prototypes", "WebGL Effects", "Canvas API"],
    },
    {
        title: "Frontend Development",
        numbering: "02",
        listItems: ["React & Vue.js", "TypeScript", "Modern CSS", "Responsive Design", "Performance Optimization"],
    },
    {
        title: "Full-Stack Solutions",
        numbering: "03",
        listItems: ["Node.js Backend", "API Development", "Database Design", "CMS Integration", "Deployment"],
    },
    {
        title: "Creative Services",
        numbering: "04",
        listItems: ["WordPress Development", "Custom Animations", "UX/UI Design", "Brand Identity", "Motion Graphics"],
    },
];
