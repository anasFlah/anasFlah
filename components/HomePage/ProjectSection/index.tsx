            ...
            <div className={styles.wrapper}>
                {portfolioData.projects.slice(0, 3).map((project) => (
                    <Link key={project.slug} href={`/projects/${project.slug}`} ref={addToRefs} className={styles.projectCard}>
                        <Image src={project.img} width={700} height={700} alt={project.title} unoptimized className={(project.slug === 'shesup-ecommerce' || project.slug === 'bk-food-international') ? styles.shadowed : undefined} />
